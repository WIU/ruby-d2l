module RubyD2L
  class OrgUnit
    ...
    def self.add_child_org_unit(params = {})
      required_params(params, [:parent_id, :child_id])
      ...
      add_child = connect(RubyD2L.site_url).request :add_child_org_unit do
        soap.xml = the_xml
      end
    ...
    def self.create_course_offering(params = {})
      required_params(params, [:offering_name, :offering_code, :template_id])
      ...
      create_offering = connect(RubyD2L.site_url).request :create_course_offering do
        soap.xml = esc_xml
      end
    ...
    def self.create_course_template(params = {})
      required_params(params, [:template_name, :template_code])
      ...
      template = connect(RubyD2L.site_url).request :create_course_template do
        soap.xml = esc_xml
      end
    ...
    def self.create_semester(params = {})
      required_params(params, [:semester_name, :semester_code, :path])
      ...
      template = connect(RubyD2L.site_url).request :create_semester do
        soap.xml = esc_xml
      end
    ...
    def self.get_child_course_templates(params = {})
      required_params(params, [:org_unit_id])
      ...
      child_templates = connect(RubyD2L.site_url).request :get_child_course_templates do
        soap.xml = the_xml
      end
    ...
    # REQUIRED:: org_unit_id => "ID"
    # RETURNS::  false if not found, values hash if found
    def self.get_child_org_units(params = {})
      required_params(params, [:org_unit_id])
      ...
      <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
        ...
        <soap:Body>
          <GetChildOrgUnitsRequest xmlns="http://www.desire2learn.com/services/oums/wsdl/OrgUnitManagementService-v1_1">
             <OrgUnitId>
               <Id xmlns="http://www.desire2learn.com/services/common/xsd/common-v1_0">' + params[:org_unit_id] + '</Id>
               <Source xmlns="http://www.desire2learn.com/services/common/xsd/common-v1_0">Desire2Learn</Source>
             </OrgUnitId>
      ...
      children = connect(RubyD2L.site_url).request :get_child_org_units do
        soap.xml = the_xml
      end

      response = children.to_hash[:get_child_org_units_response]
      if response.include?(:child_org_units)
        return response[:child_org_units][:org_unit_info]
        # return Tools.get_all_values_nested(response[:child_org_units][:org_unit_info])
      else
        return false
      end
    end
    ...
    def self.get_course_offering_by_code(params = {})
      required_params(params, [:offering_code])
      ...
      offering = connect(RubyD2L.site_url).request :get_course_offering_by_code do
        soap.xml = the_xml
      end
    ...
    def self.get_course_template_by_code(params = {})
      required_params(params, [:template_code])
      ...
      template = connect(RubyD2L.site_url).request :get_course_template_by_code do
        soap.xml = the_xml
      end
    ...
    def self.get_department_by_code(params = {})
      required_params(params, [:org_unit_code])
      ...
      department = connect(RubyD2L.site_url).request :get_department_by_code do
        soap.xml = the_xml
      end
    ...
    def self.get_semester_by_code(params = {})
      required_params(params, [:semester_code])
      ...
      semester = connect(RubyD2L.site_url).request :get_semester_by_code do
        soap.xml = the_xml
      end
